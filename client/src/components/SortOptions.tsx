...
const SortOptions = ({
  ...
  return (
    <div className="flex p-2 gap-3 z-0 mx-auto">
      <div className="text-white flex items-center justify-center text-[1.5rem] cursor-pointer">
        {order === 'asc' ? (
      ...
      {Object.entries(sortOptions).map((entry, id) => (
        <div
          ...
          style={{
            backgroundColor:
              selectedSortOption === entry[1] ? 'var(--primary)' : '',
